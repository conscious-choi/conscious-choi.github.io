...
export const BigFeed = ({}) => {
    return (
        <Col padding="40px" br="50px" bg={"rgba(23, 25, 30, 0.75)"} width="100%" style={{backdropFilter: "blur(2px)"}} mb="30px">
            <Text size="40px" lh={"65px"} weight="700" ff="Nanum Myeongjo">Spiking neural network</Text>
